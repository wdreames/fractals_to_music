...
class Lsystem:
    ...
    def __init__(self, draw_image=False, speed=0):
        self.name = ''
        self.variables = []
        self.constants = []
        self.axiom = ''
    ...
    def parse_file(self, filename):
        ...
        with open(filename, 'r') as infile:
            ...
            for line in lines:
                ...
                elif split_line[0].startswith('#') or split_line[0] == "":
    ...
    def compile(self, filename, number_of_generations):
        ...
        print("Compiling ...", self.generation.append(self.axiom))
    ...
    def expand(self, string):
        ...
        for character in string:
            if character in self.constants:
                ...
                raise Exception('[ERROR] Unknown character %s in string %s\n' % (character, string))
